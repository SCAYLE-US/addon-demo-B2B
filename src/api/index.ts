...
const adminHost = import.meta.env.NUXT_STOREFRONT_API_HOST as string | undefined;
const adminToken = import.meta.env.NUXT_STOREFRONT_API_TOKEN as string | undefined;
const sapiHost = import.meta.env.NUXT_STOREFRONT_SAPI_HOST as string | undefined;
